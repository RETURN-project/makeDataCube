...
# Find Python in this machine (location may vary accross users)
## Default installation folder for Python with Anaconda, including the user name

py_location <- "anaconda3/bin/python" #file.path("/home", Sys.getenv("USER"), "/bin/python3.6")#"/usr/bin/python3.6"#file.path("/home", Sys.getenv("USER"), "anaconda3/bin/python")
...
# Search scenes, download and add to queue
```{r Landsat}
getScenes(ext, queuefile, l1folder, metafolder, tmpfolder, cld = cld, starttime = starttime, endtime = endtime, tiers = tiers, sensors = sensors)
