...
py_location <-file.path("/home", Sys.getenv("USER"), "/bin/python3.5")#"/usr/bin/python3.6"#file.path("/home", Sys.getenv("USER"), "anaconda3/bin/python")
...
Rtmpfolder <- normalizePath(file.path('..', 'data'))# folder where all temporary R files should be stored
