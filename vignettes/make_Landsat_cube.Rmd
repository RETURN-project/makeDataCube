...
This script requires certain programs to be installed in your computer in order to work. The guide below will help you through this process. If you are familiar with GitHub Actions, you may prefer to take a look at our [installing and testing  script](https://github.com/RETURN-project/makeDataCube/blob/master/.github/workflows/r.yml).
