...
## Visual workflow
![Workflow](../img/flow.png){width=100%}
...
# Split in time domain in subintervals
nsubintervals <- 3
...
mcmapply(getScenesAux, starttimes, endtimes)
