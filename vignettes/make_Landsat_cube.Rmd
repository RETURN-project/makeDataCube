...
# Inputs
```{r}
forcefolder <- file.path('..', 'data')#forcefolder <- '/home/wanda/Documents/data/force'
...
```{r}
dllLS(l1folder, queuefolder, queuefile, tmpfolder, landsatlogfile, ext, starttime, endtime, sensors, tiers, cld)
```
...
# force-tabulate-grid datacube bottom top left right format
