...
# temp/file399f3b942666.dbf
# temp/file399f3b942666.prj
# temp/file399f3b942666.shx
# queue.txt will be updated
```
...
# systemf("find %s -name -name '*.hgt' > %s", demfolder, file.path(demfolder,'srtm.txt'))
log1starg(system)(paste0("find ", demfolder, " -name '*.hgt' > ", file.path(demfolder,'srtm.txt')), intern = TRUE, ignore.stderr = TRUE)
log1starg(system)(paste0("gdalbuildvrt -input_file_list ", file.path(demfolder,'srtm.txt'), " ", file.path(demfolder, 'srtm.vrt')))
