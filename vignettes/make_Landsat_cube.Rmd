...
systemf("find %s -name '*.hgt' > %s", 
        demfolder, file.path(demfolder, 'srtm.txt'))

systemf("gdalbuildvrt -input_file_list %s %s", 
        file.path(demfolder, 'srtm.txt'), file.path(demfolder, 'srtm.vrt'))
