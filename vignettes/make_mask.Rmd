...
fcl30 <- resample(fcl30, rst, method ='ngb')
...
# select areas that with tree cover percentage larger than user-defined threshold in 2000

# mask without fire information

# prepare fire data

# update mask with locations that experienced a fire
